...
async function run() {
  try {
    ...
    app.post('/product', async(req,res)=>{
        ...
        const result = await productCollection.insertOne(newPorduct);
        res.send(result);
    })
    ...
    //app.post is for inserting data into database
    // app.get is for getting data from database
    // app.put is for updating data into database
...
app.listen( port, () =>{
    console.log(`Tech Server Port : ${port}`);
})
